...
class Response(BaseModel):
    ...
    response: str = Field(description="AI respone to user's input. Example: There are n real-estates that match your request. I will provide you the list of real estates.")
